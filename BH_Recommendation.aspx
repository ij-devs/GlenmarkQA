<%@ page title="" language="C#" masterpagefile="~/fixitmasterpage.master" autoeventwireup="true" codefile="BH_Recommendation.aspx.cs" inherits="BH_Recommendation" %>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:Label ID="Label1" Font-Size="Medium" Font-Bold="true" Text="Brands:" Font-Names="calibri" runat="server" Visible="false"></asp:Label>
                        <asp:DropDownList ID="ddlbrand" CssClass="ddl" Width="150px" runat="server" AutoPostBack="true" onselectedindexchanged="ddlbrnd_SelectedIndexChanged" Visible="false">
                        </asp:DropDownList>
                        <script type="text/javascript">
                        ...
                        <asp:DropDownList ID="ddltag" CssClass="ddl" Width="150px" runat="server" AutoPostBack="true" onselectedindexchanged="ddltag_SelectedIndexChanged" Visible="false">
                        </asp:DropDownList>
                        <script type="text/javascript">
...
<div id="notificationPopup" runat="server" class="notification">
    ...
    <asp:Button ID="btnCloseNotification" runat="server" Text="Close" OnClick="btnCloseNotification_Click" />
            ...
            <div class="grid-wrapper">
                <asp:GridView ID="Grdemp" HeaderStyle-BorderColor="#f2f2f2"
                    ...
                    <columns>
                        ...
                        <asp:TemplateField HeaderText="Approval List" ItemStyle-HorizontalAlign="center">
                            <itemtemplate>
                                <div class="approvalAction">
                                    ...
                                    <asp:Button ID="btnApproved" Enabled="true" CssClass="addbtn" CommandArgument='<%#Eval("ZSM CODE") + ";" +Eval("ZSM_Name")+ ";" +Eval("Unblocked Percentage") + ";" +Eval("Approved")%>' CommandName="btncApproved" runat="server" Text="BH Unblock" />
                                    <asp:Button ID="btnNotApproved" Enabled="true" CssClass="addbtn" CommandArgument='<%#Eval("ZSM CODE") + ";" +Eval("ZSM_Name")+ ";" +Eval("Unblocked Percentage") + ";" +Eval("Approved")%>' CommandName="btncNotApproved" runat="server" Text="BH Block" />
                        ...
                        <asp:BoundField DataField="recommendation" SortExpression="recommendation" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderText="BH Approval" ItemStyle-Width="200px" HeaderStyle-Width="200px" Visible="false" />
                    </columns>
                </asp:GridView>
            </div>
        </div>
                    ...
                    <div class="grid-wrapper topbotMar">
                        <asp:GridView ID="Grdrprt" HeaderStyle-BorderColor="#f2f2f2"
                            ...
                            <columns>
                                ...
                                <asp:BoundField DataField="Remark" SortExpression="Remark" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderText="Remark" ItemStyle-Width="200px" HeaderStyle-Width="200px" />
                                <asp:TemplateField HeaderStyle-Width="200px" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="200px" HeaderText="BH Approval">
                                    <itemtemplate>
                                        <center>
        ...
        <br />
        <asp:Button ID="btndisapp" CssClass="addbtn" runat="server" Text="Submit" onclick="btndisapp_Click" />
    </div>
    <script type="text/javascript">
        function openNav() {
