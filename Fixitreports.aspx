...
<div style=" text-align:right;"> 
 ...
 <asp:Label ID="Label3" Font-Size="Medium" Font-Bold="true" Text="ZSM Name:" Font-Names="calibri" runat="server"></asp:Label><asp:DropDownList ID="ddlempname" Width="150px" CssClass="ddl"  runat="server" AutoPostBack="true"  onselectedindexchanged="ddlemp_SelectedIndexChanged">
    ...
    <asp:GridView ID="Grdreport" HeaderStyle-BackColor="#0d9dbc"  RowStyle-Font-Names="calibri" RowStyle-HorizontalAlign="left"
            ...
            <Columns >     
               <asp:BoundField DataField="SALES_DIVISION" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="left"  HeaderStyle-HorizontalAlign="Left" HeaderText="Division"  HeaderStyle-Width="100px" SortExpression="SALES_DIVISION" />
              ...
              <asp:BoundField DataField="ZSM NAME" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="left"  HeaderStyle-HorizontalAlign="Left" HeaderText="ZSM Name"  HeaderStyle-Width="100px" SortExpression="ZSM NAME" />
             <asp:BoundField DataField="SALES_ACC_NAME" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="left"  HeaderStyle-HorizontalAlign="Left" HeaderText="Stockist Name"  HeaderStyle-Width="100px" SortExpression="SALES_ACC_NAME" />
                <asp:BoundField DataField="SALES_PROD_NAME" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="left"  HeaderStyle-HorizontalAlign="Left" HeaderText="Product Name"  HeaderStyle-Width="100px" SortExpression="SALES_PROD_NAME" />
             <asp:BoundField DataField="SALES_2023-05" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Right"  HeaderStyle-HorizontalAlign="Right" HeaderText="Pri Sales SEP-25(V)"  HeaderStyle-Width="200px" SortExpression="SALES_2023-05" />
                <asp:BoundField DataField="SALES_2023-06" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" HeaderText="Pri Sales OCT-25(V)"  HeaderStyle-Width="200px" SortExpression="SALES_2023-06" />
              <asp:BoundField DataField="SALES_2023-07" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" HeaderText="Pri Sales NOV-25(V)"  HeaderStyle-Width="200px" SortExpression="SALES_2023-07" />
               <asp:BoundField DataField="AVG_SEC_JUL23" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="center" HeaderText="Avg.Secondary 3 months(V)"  HeaderStyle-Width="200px" SortExpression="AVG_SEC_JUL23" />
               <asp:BoundField DataField="CLO_2023_07" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" HeaderText="Closing NOV-25 (V)"  HeaderStyle-Width="200px" SortExpression="CLO_2023_07" />
             <asp:BoundField DataField="CLO_Unit_07" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" HeaderText="Closing NOV-25 (U)"  HeaderStyle-Width="200px" SortExpression="CLO_Unit_07" />
                <asp:BoundField DataField="Unblock" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderText="Unblock"  HeaderStyle-Width="70px" SortExpression="Unblock" />
              <asp:BoundField DataField="Liquidation" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderText="Liquidation Plan(Month)"  HeaderStyle-Width="50px" SortExpression="Liquidation" />
