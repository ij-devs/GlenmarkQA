 ...
 <asp:Label ID="Label3" Font-Size="Medium" Font-Bold="true" Text="ZSM Name:" Font-Names="calibri" runat="server"></asp:Label><asp:DropDownList ID="ddlempname" Width="150px" CssClass="ddl"  runat="server" AutoPostBack="true"  onselectedindexchanged="ddlemp_SelectedIndexChanged">
    ...
    <asp:GridView ID="Grdreport" HeaderStyle-BackColor="#0d9dbc"  RowStyle-Font-Names="calibri" RowStyle-HorizontalAlign="left"
            ...
            <Columns >     
             ...
             <asp:BoundField DataField="SALES_2023-05"  ItemStyle-HorizontalAlign="Right"  HeaderStyle-HorizontalAlign="Right" HeaderText="Pri Sales SEP-25(V)"  HeaderStyle-Width="200px" SortExpression="SALES_2023-05" DataFormatString="{0:N0}" />
                <asp:BoundField DataField="SALES_2023-06"  ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" HeaderText="Pri Sales OCT-25(V)"  HeaderStyle-Width="200px" SortExpression="SALES_2023-06" DataFormatString="{0:N0}" />
              <asp:BoundField DataField="SALES_2023-07"  ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" HeaderText="Pri Sales NOV-25(V)"  HeaderStyle-Width="200px" SortExpression="SALES_2023-07" DataFormatString="{0:N0}" />
               <asp:BoundField DataField="AVG_SEC_JUL23"  ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="center" HeaderText="Avg.Secondary 3 months(V)"  HeaderStyle-Width="200px" SortExpression="AVG_SEC_JUL23" DataFormatString="{0:N0}" />
               <asp:BoundField DataField="CLO_2023_07"  ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" HeaderText="Closing NOV-25 (V)"  HeaderStyle-Width="200px" SortExpression="CLO_2023_07" DataFormatString="{0:N0}" />
             <asp:BoundField DataField="CLO_Unit_07"  ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" HeaderText="Closing NOV-25 (U)"  HeaderStyle-Width="200px" SortExpression="CLO_Unit_07" DataFormatString="{0:N0}" />
