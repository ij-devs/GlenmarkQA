<%@ page title="" language="C#" masterpagefile="~/fixitmasterpage.master" autoeventwireup="true" codefile="View_DH.aspx.cs" inherits="View_DH" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="page-wrapper">
                ...
                <tr>
                    <td class="style1">
                        ...
                        <div id="mySidenav" class="sidenav">
                            ...
                            <br />
                            <asp:Button ID="Btnnav7" CssClass="button" runat="server" OnClick="btnapp" Text="Home" Visible="true" />
                            <br />
                            <asp:Button ID="Button6" CssClass="button" runat="server" OnClick="btntemp" Text="Blocking List" />
                            <br />
                            <asp:Button ID="Button3" CssClass="button" runat="server" OnClick="btnnotific" Text="Notification" />
                            <br />
                    ...
                    <td class="style2">
                        <div id="header pull-right" style="width: 109%; text-align: Left; height: 48px;">
                            ...
                            <br />
                            <%--<div id="labelStripContainer">
                <asp:Label ID="movingLabel" Font-Size="Large" Font-Bold="true" CssClass="moving-label" Font-Names="calibri" ForeColor="Red" Text="Last date of submission: 28th November 2025 till 5.00 PM" runat="server"></asp:Label>
            </div>--%>
        ...
        <div>
            <!-- Add these dropdown filters below your existing ZSM dropdown -->
        ...
        <div>
            ...
            <asp:GridView ID="Grdemp" HeaderStyle-BorderColor="#f2f2f2"
                ...
                <columns>
                    ...
                    <asp:BoundField DataField="Approved" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderText="Status" HeaderStyle-Width="100px" />
                    <asp:BoundField DataField="Submit_Time" SortExpression="Submit_Time" ItemStyle-Font-Size="Small" DataFormatString="{0:dd-MMM-yyyy HH:mm:ss}"
                    ...
                    <asp:BoundField DataField="Approved_Time" SortExpression="Approved_Time" ItemStyle-Font-Size="Small" DataFormatString="{0:dd-MMM-yyyy HH:mm:ss}"
        ...
        <center>
            <asp:Label ID="Lblnote" Font-Size="Large" Font-Bold="true" ForeColor="Green" Font-Names="calibri" runat="server">Your Unblocking list has been sent for Approval</asp:Label></center>
        <center>
