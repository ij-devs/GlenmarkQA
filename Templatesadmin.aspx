   ...
   <br />
    ...
    <asp:GridView ID="Grdemp" HeaderStyle-BackColor="#0d9dbc"
        ...
        RowStyle-Font-Names="calibri" RowStyle-HorizontalAlign="Center" 
         ...
         <asp:BoundField DataField="SALES_2023-09"  ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" HeaderText="Pri Sales SEP-25(V)"  HeaderStyle-Width="150px" SortExpression="SALES_2023-09" DataFormatString="{0:N0}" />
                <asp:BoundField DataField="SALES_2023-10"  ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" HeaderText="Pri Sales OCT-25(V)"  HeaderStyle-Width="150px" SortExpression="SALES_2023-10" DataFormatString="{0:N0}" />
              <asp:BoundField DataField="SALES_2023-11"  ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" HeaderText="Pri Sales NOV-25(V)"  HeaderStyle-Width="150px" SortExpression="SALES_2023-11" DataFormatString="{0:N0}" />
       <asp:BoundField DataField="AVG_SEC_NOV23"  ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" HeaderText="Avg.Secondary 3 months"  HeaderStyle-Width="180px" SortExpression="AVG_SEC_NOV23" DataFormatString="{0:N0}" />
           <asp:BoundField DataField="CLO_2023_11"  ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" HeaderText="Closing NOV-25 (V)"  HeaderStyle-Width="150px" SortExpression="CLO_2023_11" DataFormatString="{0:N0}" />
               <asp:BoundField DataField="CLO_Unit_11"  ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" HeaderText="Closing NOV-25 (U)"  HeaderStyle-Width="150px" SortExpression="CLO_Unit_11" DataFormatString="{0:N0}" />
           <asp:BoundField DataField="INVENTORY_DAYS" SortExpression="INVENTORY_DAYS"  ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderText="Inventory Days" ItemStyle-Width="150px" HeaderStyle-Width="150px" />
                    <asp:BoundField DataField="Tag" SortExpression="Tag"  ItemStyle-HorizontalAlign="left" HeaderStyle-HorizontalAlign="left" HeaderText="Additional Info" ItemStyle-Width="150px" HeaderStyle-Width="150px" />
